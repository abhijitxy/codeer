  ...
  return (
    <div className="h-screen bg-[#1e1e1e] text-white flex flex-col">
      ...
      <div className="h-12 bg-[#2d2d30] border-b border-[#3e3e42] flex items-center justify-between px-4">
        ...
        <div className="flex items-center space-x-4">
          <Button
            variant="ghost"
            size="sm"
            className="text-white hover:bg-[#3e3e42] h-8 px-3"
          >
          ...
          <Button
            variant="ghost"
            size="sm"
            className="text-gray-400 hover:bg-[#3e3e42] h-8 px-3"
          >
            📁 Compiler options
          </Button>
          <Button
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button
              variant="outline"
              size="sm"
              className="bg-[#1e1e1e] border-[#3e3e42] text-white hover:bg-[#2d2d30] h-8"
            >
              Sign in with Puter
            </Button>
          </div>
      ...
      <div className="flex-1 flex min-h-0">
        ...
        <div className="w-96 bg-[#1e1e1e] border-l border-[#2d2d30] flex flex-col">
          ...
          <div className="h-10 bg-[#1e1e1e] border-b border-[#2d2d30] flex items-center px-4">
            <div className="flex items-center space-x-2">
              <div
                className={`w-2 h-2 rounded-full ${openRouterApiKey ? "bg-green-500" : "bg-red-500"}`}
              ></div>
              ...
              <span className="text-xs bg-[#2d2d30] px-2 py-1 rounded text-gray-400">
                gpt-4o-mini
              </span>
            </div>
          </div>
            ...
            {aiMessages.length === 0 ? (
              <div className="text-center text-gray-400 text-sm">
                ...
                <p className="text-xs mt-1">
                  I can help with debugging, optimization, and explanations.
                </p>
              </div>
            ) : (
        ...
        <div className="w-96 bg-[#1e1e1e] border-l border-[#2d2d30] flex flex-col">
          ...
          <div className="h-12 bg-[#1e1e1e] border-b border-[#2d2d30] flex">
            <button
              ...
              className={`flex-1 text-sm font-medium border-r border-[#2d2d30] ${
                activeTab === "input"
      ...
      <div className="h-6 bg-[#007acc] flex items-center justify-between px-4 text-xs text-white">
        <div className="flex items-center space-x-4">
          <span>
            © 2024-2025 Judge0 6.0.0 - All Rights Reserved • A Croatian ❤️
            company
          </span>
        </div>
        <div className="flex items-center space-x-4">
