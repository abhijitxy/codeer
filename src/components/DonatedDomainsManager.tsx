      ...
      {domains.length === 0 ? (
        <div className="text-center py-12">
          <div className="text-gray-400 mb-4">
            ...
            >
              <path
                ...
                strokeWidth={1}
                d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-6m-2-5a2 2 0 11-4 0 2 2 0 014 0z"
              />
            </svg>
          </div>
          ...
          <p className="text-gray-400 mb-4">
            You haven't donated any domains yet. Share your domains with the
            community!
          </p>
          <button
            onClick={() => setShowDonationModal(true)}
          ...
          {domains.map((domain) => (
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400 mt-1">
                    {(
                      (domain.current_subdomains / domain.max_subdomains) *
                      100
                    ).toFixed(1)}
                    %
                  </div>
              ...
              <div className="flex space-x-3">
                <button
                  onClick={() =>
                    handleToggleStatus(domain.id, domain.is_active)
                  }
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold text-white">
                  Domain Usage -{" "}
                  {domains.find((d) => d.id === selectedDomain)?.domain_name}
                </h3>
                <button
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span
                              className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                                usage.user_pages?.status === "active"
                                  ? "bg-green-900/30 text-green-400"
