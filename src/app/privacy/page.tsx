      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          <section>
            ...
            <p className="mb-4">
              Codeer collects information to provide better services to our
              users. We collect information in the following ways:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                <strong>Account Information:</strong> When you create an account
                via GitHub OAuth, we collect your GitHub username, email
                address, and profile information.
              </li>
              <li>
                <strong>Usage Data:</strong> We collect information about how
                you use our compiler, including code execution patterns,
                language preferences, and feature usage.
              </li>
              <li>
                <strong>Technical Data:</strong> We automatically collect IP
                addresses, browser type, device information, and other technical
                data for service improvement and security.
              </li>
              <li>
                <strong>Cookies and Local Storage:</strong> We use cookies and
                local storage to enhance your experience and remember your
                preferences.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              Codeer uses Google AdSense to display advertisements. Google
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                ...
                based on user's prior visits to our website
              </li>
              <li>
                Google's use of advertising cookies enables it and its partners
                to serve ads based on visits to our site and/or other sites on
                the Internet
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                <strong>Portability:</strong> You can request export of your
                data
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              continued use of our service after such modifications constitutes
          ...
          <section>
            ...
            <p>
              ...
              located. By using our service, you consent to such transfer,
...
export const metadata = {
  ...
  description:
    "Codeer's Privacy Policy - Learn how we collect, use, and protect your personal information when using our online compiler service.",
  robots: "index, follow",
};
