        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-800 bg-black/95 backdrop-blur">
            <div className="px-4 py-3 space-y-1">
              ...
              <Link
                href="/login"
                className="block mt-4 bg-white text-black px-4 py-3 rounded text-sm font-medium hover:bg-gray-200 transition-colors text-center"
                onClick={() => setMobileMenuOpen(false)}
              >
                Get Started
              </Link>
      ...
      <section className="py-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col items-center mb-8 relative">
            ...
            <div
              className="absolute -top-2 -right-6 w-1 h-1 bg-gray-500 rounded-full animate-pulse"
              style={{ animationDelay: "1s" }}
            ></div>
            <div
              className="absolute -bottom-2 -left-6 w-1 h-1 bg-gray-400 rounded-full animate-pulse"
              style={{ animationDelay: "2s" }}
            ></div>
            <div
              className="absolute -bottom-4 -right-4 w-2 h-2 bg-gray-500 rounded-full animate-pulse"
            ...
            <h2
              className="text-4xl font-bold text-white mb-2 relative uppercase"
              style={{ fontFamily: "var(--font-gugi)" }}
            >
              CODEER
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight relative">
              Free Online.<span className="text-gray-400"> Compiler.</span>
              <br />
            ...
            <div className="text-gray-400 text-lg mb-8 leading-relaxed max-w-2xl mx-auto relative">
              Free online compiler and code editor supporting 50+ programming
              languages including Python, JavaScript, Java, C++, C, Go, Rust.
              Write, run, test and debug code instantly in your browser. Perfect
              for coding practice, algorithms, and programming education.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
              ...
              <Link
                href="/login"
                className="border border-gray-700 px-8 py-3 rounded-lg font-medium hover:bg-gray-900 inline-flex items-center justify-center gap-2"
              >
                ...
                <div className="flex items-center justify-between px-6 py-4 bg-gray-900 border-b border-gray-800">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-400">
                      main.{languages[currentLang].toLowerCase()}
                    </span>
                  </div>
                  <motion.div
                    key={currentLang}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-4">
              Best Free Online Compiler & Code Editor
            </h2>
            <p className="text-gray-400">
              Complete online development environment for coding, compiling, and
              debugging
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Compile and run code in under 2 seconds. No downloads or setup required.",
              },
              {
                icon: CodeIcon,
                title: "50+ Programming Languages",
                desc: "Python, JavaScript, Java, C++, C, Go, Rust, PHP, Ruby, Swift, Kotlin and more",
              },
              {
                icon: GitHubLogoIcon,
                title: "GitHub Integration",
                desc: "Import, edit and save code directly from GitHub repositories",
              },
              {
                icon: RocketIcon,
                title: "Zero Setup Required",
                desc: "Start coding immediately in your browser. No installation needed.",
              },
            ].map((feature, index) => (
              <div
                key={index}
                className="p-6 bg-black border border-gray-800 rounded-lg hover:border-gray-700 transition-colors"
              >
      ...
      <section id="languages" className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400">
              Free online compiler supporting all major programming languages
              for coding practice and development
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              <div
                key={index}
                className="p-3 bg-gray-950 border border-gray-800 rounded-lg text-center hover:bg-gray-900 transition-colors"
              >
      ...
      <section className="py-12 bg-gray-950">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400">
              Join thousands of developers using our free online compiler
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center">
              Best Free Online Compiler for Programming
            </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 text-gray-300">
                <div>
                  <h3 className="text-xl font-semibold mb-4 text-white">
                    Why Use Codeer Online Compiler?
                  </h3>
                  <p className="mb-4">
                    Codeer is the best free online compiler and code editor that
                    supports over 50 programming languages. Whether you're
                    learning to code, practicing algorithms, or working on
                    programming projects, our online compiler provides
                    everything you need without any downloads or installations.
                  </p>
                  <p className="mb-4">
                    Our free online compiler supports popular languages like
                    Python, JavaScript, Java, C++, C, Go, Rust, PHP, Ruby,
                    Swift, Kotlin, TypeScript, and many more. Start coding
                    instantly in your browser with syntax highlighting,
                ...
                <div>
                  ...
                  <p className="mb-4">
                    Practice coding problems, solve algorithms, and prepare for
                    programming interviews with our online code editor. No setup
                    required - just open your browser and start coding. Perfect
                    for students, beginners, and experienced developers alike.
                  </p>
                  <p className="mb-4">
                    Features include instant code execution, GitHub integration,
                    code sharing, and support for multiple programming
                    paradigms. Our online development environment is optimized
                    for speed and reliability, ensuring your code runs smoothly
                    every time.
                  </p>
                </div>
              </div>
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="p-8 bg-gray-950 border border-gray-800 rounded-lg">
            ...
            <Link
              href="/ide"
              className="bg-white text-black px-8 py-3 rounded font-medium hover:bg-gray-200 inline-flex items-center gap-2"
            >
