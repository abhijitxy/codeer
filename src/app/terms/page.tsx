      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          <section>
            ...
            <p>
              By accessing and using Codeer ("the Service"), you accept and
          ...
          <section>
            ...
            <p className="mb-4">
              Codeer is a free online compiler and code editor that allows users
              to:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Write, edit, and execute code in 50+ programming languages
              </li>
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              account using GitHub OAuth. By creating an account, you agree to:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Execute malicious code or attempt to harm our systems or other
                users
              </li>
              ...
              <li>
                Upload or execute code that violates GitHub's Terms of Service
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              You retain ownership of the code and content you create using our
              Service. However, by using the Service, you grant us:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                A non-exclusive license to host, store, and display your content
                as necessary to provide the Service
              </li>
              <li>
                The right to use anonymized, aggregated data for service
                improvement
              </li>
          ...
          <section>
            ...
            <p className="mt-4">
              We reserve the right to impose reasonable limits on resource
              usage, including execution time, memory usage, and API requests.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              Our Service may display advertisements through Google AdSense and
            ...
            <p className="mt-4">
              ...
              terms of service of these third-party providers.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, CODEER SHALL NOT BE LIABLE
              FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE
              DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, OR
              USE, ARISING OUT OF OR RELATING TO YOUR USE OF THE SERVICE.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              time, with or without cause or notice, for conduct that we
              believe:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            ...
            <p>
              ...
              email. Your continued use of the Service after such modifications
...
export const metadata = {
  ...
  description:
    "Codeer's Terms of Service - Read our terms and conditions for using our online compiler and code editor service.",
  robots: "index, follow",
};
